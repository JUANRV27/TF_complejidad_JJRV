...
def update_graph(start_node, end_node, relayout_data):
    ...
    # Crear el gráfico para el camino más corto
    path_data = [edges_trace]  # Aristas del grafo completo
    ...
    if start_node and end_node:
        try:
            ...
            path_data.append(path_trace)
        except nx.NetworkXNoPath:
            path_data.append(go.Scattermapbox())  # Si no hay camino

    # Mapa del camino más corto
    fig_path = go.Figure(
        data=path_data,
        layout=go.Layout(
